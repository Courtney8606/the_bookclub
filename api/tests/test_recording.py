...
def test_creates_recording_instance():
    ...
    recording = Recording(1, "test.mp3", "test audio file", 1, 2, "pending")
...
def test_record_is_equal():
    recording_1 = Recording(1, "test.mp3", "test audio file", 1, 2, "pending")
    recording_2 = Recording(1, "test.mp3", "test audio file", 1, 2, "pending")
