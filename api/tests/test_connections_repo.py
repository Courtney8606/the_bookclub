...
def test_get_all_connections(db_connection): 
    ...
    assert result == [
    {"id": 1, "parent_id": 1,"reader_id": 2, "status": "approved", "display_message_icon": True},
    {"id": 2, "parent_id": 2, "reader_id": 3, "status":'approved', "display_message_icon": True},
    {"id": 3, "parent_id":1, "reader_id":3, "status": 'rejected', "display_message_icon": False}
    ]
...
def test_create_connection(db_connection):
    ...
    {"id": 2, "parent_id": 2, "reader_id": 3, "status":'approved', "display_message_icon": True},
    {"id": 3, "parent_id":1, "reader_id":3, "status": 'rejected', "display_message_icon": False},
    {"id": 4,"parent_id": 1, "reader_id":2, "status":'pending', "display_message_icon": True}
    ]
...
def test_update_status(db_connection):
    ...
    {"id": 1, "parent_id": 1,"reader_id": 2, "status": "approved", "display_message_icon": True},
    {"id": 2, "parent_id": 2, "reader_id": 3, "status":'approved', "display_message_icon": True},
    {"id": 3, "parent_id":1, "reader_id":3, "status": 'approved', "display_message_icon": True}
    ]
